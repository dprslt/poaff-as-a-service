...
googleMapsConstruct     = False      #Normaly = True
...
scriptProcessing = {
    ...
    "SIA-XML":              {poaffCst.cstSpExecute:None         , poaffCst.cstSpProcessType:None,                     poaffCst.cstSpOutPath:"../output/SIA/",    poaffCst.cstSpSrcFile:"../input/SIA/20260219-20260219_AIRAC-0225_xml_SIA-FR.xml"                        ,poaffCst.cstSpSrcOwner:"https://www.sia.aviation-civile.gouv.fr"},
    ...
    "SIA-AIXM":             {poaffCst.cstSpExecute:not(testMode), poaffCst.cstSpProcessType:poaffCst.cstSpPtAddDelta, poaffCst.cstSpOutPath:"../output/SIA/",    poaffCst.cstSpSrcFile:"../input/SIA/20260219-20260219_AIRAC-0225_aixm4.5_SIA-FR.xml"                        ,poaffCst.cstSpSrcOwner:"https://www.sia.aviation-civile.gouv.fr"},
...
if __name__ == '__main__':
    ...
    # Parse CLI arguments for dynamic file paths
    parser = argparse.ArgumentParser(description='POAFF - Paragliding Openair French Files')
    parser.add_argument('--sia-xml', type=str, help='Path to SIA XML file')
    parser.add_argument('--sia-aixm', type=str, help='Path to SIA AIXM file')
    args, remaining = parser.parse_known_args()
    
    # Update scriptProcessing with CLI-provided paths
    if args.sia_xml:
        scriptProcessing["SIA-XML"][poaffCst.cstSpSrcFile] = args.sia_xml
        print(f"Using SIA-XML file: {args.sia_xml}")
    if args.sia_aixm:
        scriptProcessing["SIA-AIXM"][poaffCst.cstSpSrcFile] = args.sia_aixm
        print(f"Using SIA-AIXM file: {args.sia_aixm}")
